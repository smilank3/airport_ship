              ...
              <div className="card mt-3">
                ...
                <ul className="list-group list-group-flush">
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span className="text-secondary" style={{color:'black',fontWeight:500,marginLeft:'9px'}}>{!props.userProfile.airportLocation.airportName?"not assigned":(
                    	`${props.userProfile.airportLocation.airportName}, ${props.userProfile.airportLocation.airportCity},${props.userProfile.airportLocation.airportCountry}`)}</span>
                 </h6> </li>
...
// no need as userProfile is available from _app.js
/*
